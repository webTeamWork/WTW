...
create table user(
    ...
    active_code varchar(32) default 1,	#激活码
    hasActive int	#用户状态状态
)charset=utf8;

INSERT INTO `user` 
VALUES ('1','qq123','123','男',NULL,'123@qq.com','0','2021-03-17 21:54:37','hello','0',NULL,1)
, ('2','张建浩','123','女',NULL,'456@qq.com','0','2021-03-16 21:55:33','空你起哇','0',NULL,1);
...
insert into notice values (1,1,'社区问答-数据结构背后的原理','2021-03-17 22:09:38','社区问答-数据结构背后的原理'),
(2,1,'不容错过，知识库精华资源推荐','2021-03-20 23:45:00','不容错过，知识库精华资源推荐'),
(3,1,'2021年上半年热门下载资源','2021-03-18 22:09:38','2021年上半年热门下载资源'),
(4,1,'问答2021年3月活动开始啦！','2021-03-19 22:09:38','问答2021年3月活动开始啦！');
